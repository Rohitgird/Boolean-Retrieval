...
elif(form.getvalue('sel')=='2'):
    print (words[2])

elif(form.getvalue('sel')=='3'):
    print (words[3])

elif(form.getvalue('sel')=='4'):
    print (words[4])

elif(form.getvalue('sel')=='5'):
    print (words[5])

elif(form.getvalue('sel')=='6'):
    print (words[6])

elif(form.getvalue('sel')=='7'):
    print (words[7])

elif(form.getvalue('sel')=='8'):
    print (words[8])

elif(form.getvalue('sel')=='9'):
    print (words[9])

elif(form.getvalue('sel')=='10'):
    print (words[10])

elif(form.getvalue('sel')=='11'):
    print (words[11])

elif(form.getvalue('sel')=='12'):
    print (words[12])
